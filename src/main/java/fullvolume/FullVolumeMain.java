...
import fullvolume.util.GeneralUtils;
import fullvolume.util.KeywordInfo;
import fullvolume.util.TextureLoader;
...
@SpireInitializer
public class FullVolumeMain implements
    ...
    private static final String resourcesFolder = "fullvolume";
    ...
    public void receivePostInitialize() {
        ...
        Settings.SOUND_VOLUME = 1f;
        Settings.MUSIC_VOLUME = 1f;
        Settings.MASTER_VOLUME = 1f;
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(FullVolumeMain.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
